          ...
          if (!snapshot.hasData || snapshot.hasError) {
            ...
            return Scaffold(
              ...
              body: PageView.builder(
                ...
                onPageChanged: (idx) => state.progress = (idx / (quiz.questions.length + 1)),
                itemBuilder: (context, idx) {
                  ...
                  // Doing -1 because 0th page is actually the start page
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: question.options.map((option) => OptionItem(option: option)).toList(),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(children: [
          Icon(state.selected == option ? FontAwesomeIcons.checkCircle : FontAwesomeIcons.circle, size: 30),
          Expanded(
            child: Container(
